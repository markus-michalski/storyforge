...
13. ALWAYS call `add_canon_fact(book_slug, chapter_slug, subject, fact, domain)` after writing or revising a chapter — track new and changed facts in DB. For revisions use `is_revision=True` + `old_value` + `revision_impacts`.
