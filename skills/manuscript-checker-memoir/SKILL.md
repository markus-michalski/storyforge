...
`chapter-writer-memoir` (Step 6c) and at review-time by
`chapter-reviewer-memoir`. See `reference/craft/repetition-category-rules.md`
for how the two combine during Step 5's interactive fix mode.
